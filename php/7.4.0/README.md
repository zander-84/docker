...
```
docker build   ./ -t registry.cn-hangzhou.aliyuncs.com/zander84/myphp:v7.4.0
```
...
-v /code/:/code/   \
-v /code/docker/php/7.4.0/mongo/dev/www.conf:/www/server/php/etc/php-fpm.d/www.conf   \
-v /code/docker/php/7.4.0/mongo/dev/php.ini:/www/server/php/conf/php.ini   \
--privileged \
registry.cn-hangzhou.aliyuncs.com/zander84/myphp:v7.4.0
```
